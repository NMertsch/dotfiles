...
# prompt
PS1="\[\e[1m\e[36m\]\w\[\e[0m\] \[\e[1m\]\$\[\e[0m\] "

# >>> conda initialize >>>
# !! Contents within this block are managed by 'conda init' !!
__conda_setup="$('/home/niklas/.local/etc/miniconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/niklas/.local/etc/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/niklas/.local/etc/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/niklas/.local/etc/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
